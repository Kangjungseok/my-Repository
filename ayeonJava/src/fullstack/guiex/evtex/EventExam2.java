...
//2번 방법 : 내가 직접 Listener를 상속해서 구현객체가 되는 방법...

//윈도우리스너를 상속받은 윈도우 아답터를 상속해서 윈도우 이벤트 구현객체로 정의합니다. 
class WindowDefine2 extends WindowAdapter{
	@Override
...
class EvtEx2 extends Frame implements ActionListener{
	...
	private void start() {
		...
		this.addWindowListener(new WindowDefine2());
